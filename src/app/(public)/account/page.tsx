  ...
  return (
    <div className="px-4 pt-6 pb-24 md:mx-auto md:max-w-[600px] md:px-6 md:pt-12">
      ...
      <div className="mb-6 grid grid-cols-3 gap-3">
        <Link href="/account/favorites" className="rounded-xl border border-border-subtle bg-bg-elevated p-4 text-center transition-colors hover:border-border-default">
          <Heart className="mx-auto mb-2 h-5 w-5 text-purple-500" />
          <span className="text-xs font-medium">Favoris</span>
        </Link>
        <Link href="/account/history" className="rounded-xl border border-border-subtle bg-bg-elevated p-4 text-center transition-colors hover:border-border-default">
          <Clock className="mx-auto mb-2 h-5 w-5 text-purple-500" />
          <span className="text-xs font-medium">Historique</span>
        </Link>
        <Link href="/account/mixing" className="rounded-xl border border-border-subtle bg-bg-elevated p-4 text-center transition-colors hover:border-border-default">
