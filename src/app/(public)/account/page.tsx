  ...
  return (
    <div className="px-4 pt-6 pb-24 md:mx-auto md:max-w-[600px] md:px-6 md:pt-12">
      ...
      <div className="flex gap-3 mb-6 flex-wrap">
        <Link href="/account/history" className="flex-1 min-w-[100px] rounded-xl border border-border-subtle bg-bg-elevated p-4 text-center transition-colors hover:border-border-default">
          <Clock className="mx-auto mb-2 h-5 w-5 text-purple-500" />
          <span className="text-xs font-medium">Historique</span>
        </Link>
        <Link href="/account/favorites" className="flex-1 min-w-[100px] rounded-xl border border-border-subtle bg-bg-elevated p-4 text-center transition-colors hover:border-border-default">
          <Heart className="mx-auto mb-2 h-5 w-5 text-pink-500" />
          <span className="text-xs font-medium">Coups de cœur</span>
        </Link>
        <Link href="/account/mixing" className="flex-1 min-w-[100px] rounded-xl border border-border-subtle bg-bg-elevated p-4 text-center transition-colors hover:border-border-default">
